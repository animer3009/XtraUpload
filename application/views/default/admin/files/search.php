<h2 style="vertical-align:middle"><img src="<?=base_url().'img/icons/documents_32.png'?>" class="nb" alt="" /> <?=$this->lang->line('files_search_headertitle'); ?></h2>
<form action="<?=site_url('admin/files/search')?>" onsubmit="submitSearch(); return false;"  method="get">
	<p>
		<label><?=$this->lang->line('files_search_searchlabel'); ?></label>
