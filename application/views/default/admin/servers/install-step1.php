...
<form action="<?=site_url('/admin/server/install/'.$sid)?>" method="post">
	...
	<input type="hidden" name="ftp_url" value="<?=$this->input->post('ftp_url')?>" size="50"/>
	<input type="hidden" name="ftp_user" value="<?=$this->input->post('ftp_user')?>" size="20"/>
	<input type="hidden" name="ftp_pass" value="<?=$this->input->post('ftp_pass')?>" size="20"/>
	<input type="hidden" name="ftp_port" value="<?=($this->input->post('ftp_port') ? $this->input->post('ftp_port') : '21')?>" size="7"/>
	<input type="hidden" name="ftp_path" value="<?=$this->input->post('ftp_path')?>" size="50"/>
