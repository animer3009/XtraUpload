<h2><img alt="" class="nb" src="<?=base_url().'img/icons/user_32.png'?>" /><?=$this->lang->line('user_login_header')?></h2>
<?=$errorMessage?>
<div id="login">
<form action="<?=site_url('user/login')?>" method="post" class="loginform">
<input type="hidden" name="submit" value="1" />
	<p>
		<label for="username"><b><?=$this->lang->line('user_login_1')?></b></label>
		...
		<label for="password"><b><?=$this->lang->line('user_login_2')?></b></label>
