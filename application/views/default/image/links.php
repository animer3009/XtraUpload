<h2><img src="<?=base_url().'img/icons/pictures_32.png'?>" class="nb" alt="" /> <?=$this->lang->line('image_links_header') ?></h2>
<p>
	<label><?=$this->lang->line('image_links_1') ?></label>
	<img src="<?=$thumb_url?>" alt=""  /><br />
	<br />
	<?=$this->lang->line('image_links_2') ?><a rel="external" href="<?=$down?>"><?=$down?></a>
</p>

<h3><?=$this->lang->line('image_links_3') ?></h3>
<p>
	<label><?=$this->lang->line('image_links_4') ?></label>
	...
	<label><?=$this->lang->line('image_links_5') ?></label>
	...
	<label><?=$this->lang->line('image_links_6') ?></label>
	...
	<label><?=$this->lang->line('image_links_7') ?></label>
	...
	<label><?=$this->lang->line('image_links_8') ?></label>
	...
	<label><?=$this->lang->line('image_links_9') ?></label>
	...
	<label><?=$this->lang->line('image_links_10') ?></label>
	...
	<label><?=$this->lang->line('image_links_11') ?></label>
