...
class User extends CI_Controller
{
	...
	public function register()
	{
		...
		if($this->input->post('posted'))
		{
			...
			if (!$run)
			{
				$error = str_replace(array('<p>','</p>'),array('','<br />'),$this->form_validation->error_string());
				if(!$rows)
				{
	...
	public function _username_check($str)
	{
		...
		if($num == 1)
		{
			$this->form_validation->set_message('username_check', $this->lang->line('user_controller_24'));
			return FALSE;
		}
		else
		{
	...
	public function _username_check_forgot($str)
	{
		...
		{
			$this->form_validation->set_message('username_check_forgot', $this->lang->line('user_controller_25'));
			return false;
		}
	}
	...
	public function _email_check($str)
	{
		...
		if($num == 1)
		{
			$this->form_validation->set_message('email_check', $this->lang->line('user_controller_26'));
			return FALSE;
		}
		else
		{
	...
	public function _email_check_forgot($str)
	{
		...
		if($num != 1)
		{
			$this->form_validation->set_message('email_check_forgot', $this->lang->line('user_controller_27'));
			return FALSE;
		}
		else
		{
	...
	public function _password_check($str)
	{
		...
		if($num != 1)
		{
			$this->form_validation->set_message('password_check', $this->lang->line('user_controller_28'));
			return FALSE;
		}
		else
		{
