...
label.error {
	display: inline;
	background: left center url(../public/img/fam/exclamation.png) no-repeat;
	padding-left: 18px;
	margin-left: 4px;
	margin-bottom: 12px;
	color: #FF3300;
...
span.cssbutton a, span.cssbutton button {
	...
	font-family: "Lucida Grande", Tahoma, Arial, Verdana, serif;
	font-size: 100%;
	line-height: 130%;
	text-decoration: none;
	font-weight: bold;
...
span.cssbutton button.buttonGreen, span.cssbutton a.buttonGreen {
	color: #529214;
}
...
span.cssbutton a.buttonRed, button.buttonRed {
	color: #d12f19;
}
...
<script type="text/javascript" src="../public/js/main.php"></script>
